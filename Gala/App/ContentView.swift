...
struct ContentView: View {
    ...
    var chatView: some View {
        ChatView(showChat: $chat.showChat, userChat: $chat.userChat, viewModel: chat, distanceCalculator: DistanceCalculator(lng: chat.userChat.location.lng, lat: chat.userChat.location.lat), messages: $chat.tempMessages, snaps: $chat.snaps, timeMatched: $chat.timeMatched, demo: chat.demo ? true : false)
