                ...
                ZStack {
                    ...
                    HStack {
                        ...
                        Image(systemName: "person")
                            ...
                            .foregroundColor(pageSelection == 0 || elegantPageSelection == 0 ? Color(.systemTeal) : .gray)
                ...
                ZStack {
                    ...
                    HStack {
                        Image(systemName: "message")
                            ...
                            .foregroundColor(pageSelection == 1 || elegantPageSelection == 1 ? Color.pink : .gray)
                ...
                ZStack {
                    ...
                    HStack {
                        Image(systemName: "camera")
                            ...
                            .foregroundColor(pageSelection == 2 || elegantPageSelection == 2 ? Color.yellow : .gray)
                ...
                ZStack {
                    ...
                    HStack {
                        Image(systemName: "person.2")
                            ...
                            .foregroundColor(pageSelection == 3 || elegantPageSelection == 3 ? Color.orange : .gray)
